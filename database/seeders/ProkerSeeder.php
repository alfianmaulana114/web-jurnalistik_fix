...
class ProkerSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if ($koordinatorRedaksi && $proker1) {
            $proker1->panitia()->syncWithoutDetaching([
                $koordinatorRedaksi->id => [
        ...
        if ($koordinatorLitbang && $proker2) {
            $proker2->panitia()->syncWithoutDetaching([
                $koordinatorLitbang->id => [
        ...
        if ($koordinatorMediaKreatif && $proker3) {
            $proker3->panitia()->syncWithoutDetaching([
                $koordinatorMediaKreatif->id => [
