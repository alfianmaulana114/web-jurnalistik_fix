...
class ContentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Content 1: Artikel Published
        Content::create([
            'judul' => 'Mahasiswa Teknik Raih Juara Robotika Nasional',
            'konten' => 'Tim robotika Universitas berhasil meraih juara pertama dalam kompetisi robotika nasional yang diselenggarakan di Jakarta. Tim yang terdiri dari 5 mahasiswa fakultas teknik ini berhasil mengalahkan 50 tim dari seluruh Indonesia.
...
Dekan Fakultas Teknik, Prof. Dr. Budi Santoso, mengapresiasi prestasi yang diraih mahasiswa. "Ini adalah bukti kualitas pendidikan teknik di universitas kita," katanya.',
            'jenis_konten' => Content::TYPE_BERITA,
            'sumber' => 'Wawancara langsung dengan tim robotika',
            'catatan_editor' => 'Artikel sudah sesuai standar jurnalistik, siap publikasi',
        ...
        // Content 2: Artikel dalam Review
        Content::create([
            'judul' => 'Dampak Kenaikan UKT Terhadap Mahasiswa Kurang Mampu',
            'konten' => 'Kenaikan Uang Kuliah Tunggal (UKT) untuk semester genap 2025 menimbulkan kekhawatiran di kalangan mahasiswa, terutama mereka yang berasal dari keluarga kurang mampu.
...
Wakil Rektor Bidang Keuangan, Dr. Andi Wijaya, menjelaskan bahwa kenaikan ini diperlukan untuk meningkatkan kualitas pendidikan dan fasilitas kampus. "Kami juga menyediakan berbagai program bantuan untuk mahasiswa yang membutuhkan," tambahnya.',
        ...
        // Content 3: Feature Story Draft
        Content::create([
            'judul' => 'Inovasi Mahasiswa dalam Teknologi Berkelanjutan',
            'konten' => 'Di tengah isu perubahan iklim global, mahasiswa Universitas menunjukkan kepedulian mereka melalui berbagai inovasi teknologi berkelanjutan.
...
Selain itu, mahasiswa fakultas pertanian juga mengembangkan sistem hidroponik pintar yang dapat dikendalikan melalui smartphone. Sistem ini menggunakan sensor untuk memantau kondisi tanaman dan memberikan nutrisi secara otomatis.',
            'jenis_konten' => Content::TYPE_FEATURE,
        ...
        Content::create([
            ...
            'konten' => 'Di era digital seperti sekarang ini, literasi digital bukan lagi menjadi pilihan, melainkan kebutuhan yang mendesak. Kemampuan untuk memahami, menggunakan, dan mengevaluasi informasi digital menjadi kunci sukses dalam berbagai aspek kehidupan.
...
Oleh karena itu, kurikulum yang mengintegrasikan literasi digital perlu terus dikembangkan. Bukan hanya di fakultas teknologi, tetapi di semua fakultas tanpa terkecuali.',
            'jenis_konten' => Content::TYPE_EDITORIAL,
        ...
        // Content 5: Opini
        Content::create([
            'judul' => 'Peran Mahasiswa dalam Pembangunan Berkelanjutan',
            'konten' => 'Sebagai generasi penerus bangsa, mahasiswa memiliki peran strategis dalam mewujudkan pembangunan berkelanjutan. Konsep sustainable development yang mencakup aspek ekonomi, sosial, dan lingkungan harus menjadi perhatian serius mahasiswa.
...
Universitas sebagai rumah kedua mahasiswa harus memberikan ruang dan dukungan untuk aktualisasi peran tersebut.',
            'jenis_konten' => Content::TYPE_OPINI,
