...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg border border-[#D8C4B6]/40 shadow-sm hover:shadow-md transition-all p-6">
        <form method="GET" action="{{ route(($routePrefix ?? 'koordinator-litbang.view').'.news.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
            ...
            <div class="flex items-end space-x-2">
                ...
                <a href="{{ route(($routePrefix ?? 'koordinator-litbang.view').'.news.index') }}" class="px-4 py-2 bg-white text-[#1b334e] border border-[#D8C4B6]/40 rounded-lg font-semibold text-xs uppercase tracking-widest hover:bg-[#f9b61a]/10 focus:outline-none transition-all duration-150">
                    ...
                    <tr class="hover:bg-[#f9b61a]/5 transition-colors">
                        ...
                        <td class="whitespace-nowrap px-6 py-4">
                            <div class="flex items-center gap-2">
                                <a href="{{ route(($routePrefix ?? 'koordinator-litbang.view').'.news.show', $item->id) }}" class="rounded-lg p-2 text-[#1b334e] hover:bg-[#f9b61a]/10 transition-all" title="Lihat Detail">
