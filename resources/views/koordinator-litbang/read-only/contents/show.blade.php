            ...
            <div class="card border border-[#D8C4B6]/40">
                <div class="card-header bg-white border-b border-[#D8C4B6]/40">
                    ...
                    <div class="card-tools">
                        <a href="{{ route(($routePrefix ?? 'koordinator-litbang.view').'.contents.index') }}" class="btn btn-secondary btn-sm">
                                    ...
                                    @if($content->isCaptionBerita() && $content->berita)
                                        <div class="card mb-3 border border-[#D8C4B6]/40">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="{{ route(($routePrefix ?? 'koordinator-litbang.view').'.news.show', $content->berita->id) }}" 
                                                   target="_blank" 
                                    ...
                                    @if($content->isCaptionDesain() && $content->desain)
                                        <div class="card mb-3 border border-[#D8C4B6]/40">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="{{ route(($routePrefix ?? 'koordinator-litbang.view').'.designs.show', $content->desain) }}" 
                                                   target="_blank" 
                                                    class="btn btn-sm btn-outline-primary mt-2">
