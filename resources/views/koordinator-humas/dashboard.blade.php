{{-- Dashboard Koordinator Humas
    - Ringkasan berita, brief, caption, dan design
    - Fokus pada aktivitas divisi humas
--}}
        ...
        <div class="group relative overflow-hidden rounded-xl border border-[#D8C4B6]/40 bg-white p-5 shadow-sm transition-all hover:shadow-md">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="mt-2 text-2xl font-bold tracking-tight text-[#1b334e]">{{ $humas_total }}</p>
                    <p class="text-xs text-gray-500 mt-1">{{ $humas_coordinators }} Koordinator, {{ $humas_members }} Anggota</p>
                </div>
    ...
    <div class="rounded-xl border border-[#D8C4B6]/40 bg-white shadow-sm">
        <div class="border-b border-[#D8C4B6]/40 p-5">
            <div>
                ...
                <p class="mt-0.5 text-xs text-gray-600">Grafik aktivitas bulanan divisi humas</p>
            </div>
        </div>
        <div class="p-5">
