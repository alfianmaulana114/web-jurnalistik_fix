...
@section('header', 'Penjadwalan Anggota Humas')
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="flex items-center gap-4">
                <div>
                    ...
                    <p class="mt-0.5 text-xs text-gray-600">Kelola jadwal anggota humas</p>
                </div>
                
                <!-- Filter Bulan dan Tahun -->
                <form method="GET" action="{{ route('koordinator-humas.penjadwalan.index') }}" class="flex items-center gap-2">
                    ...
                    <a href="{{ route('koordinator-humas.penjadwalan.index') }}" class="inline-flex items-center gap-1.5 rounded-lg border border-[#D8C4B6]/40 bg-white px-4 py-2 text-sm font-medium text-[#1b334e] shadow-sm transition-all hover:shadow-md hover:bg-[#f9b61a]/10">
...
<div id="penjadwalanModal" class="hidden fixed z-50 inset-0 overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="bg-white rounded-xl border border-[#D8C4B6]/40 shadow-xl max-w-md w-full relative z-10">
            ...
            <form id="penjadwalanForm" method="POST" action="{{ route('koordinator-humas.penjadwalan.store') }}">
                @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.showCreateModal = function(date = null) {
        ...
        form.action = '{{ route("koordinator-humas.penjadwalan.store") }}';
        form.method = 'POST';
    ...
    window.editPenjadwalan = function(id, data) {
        ...
        const form = document.getElementById('penjadwalanForm');
        form.action = `/koordinator-humas/penjadwalan/${id}`;
        form.method = 'POST';
        form.setAttribute('data-submit-allowed', 'true');
