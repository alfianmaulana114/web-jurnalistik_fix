...
function applyFilter() {
    ...
    window.location.href = '/koordinator-humas/view/laporan' + '?' + params.toString();
}

function resetFilter() {
    document.getElementById('filterForm').reset();
    window.location.href = '/koordinator-humas/view/laporan';
}
...
function viewReport(type) {
    ...
    let url = `/koordinator-humas/view/laporan?tahun=${tahun}&periode=${periode}`;
...
function exportReport(type) {
    ...
    let url = `/koordinator-humas/view/laporan/export-excel?type=${type}&tahun=${tahun}&periode=${periode}`;
    if (periode === 'custom' && tanggalMulai && tanggalSelesai) {
        url += `&tanggal_mulai=${encodeURIComponent(tanggalMulai)}&tanggal_selesai=${encodeURIComponent(tanggalSelesai)}`;
    }
...
function exportAllReports() {
    ...
    let url = `/koordinator-humas/view/laporan/export-excel?type=total-saldo&tahun=${tahun}&periode=${periode}`;
    if (periode === 'custom' && tanggalMulai && tanggalSelesai) {
        url += `&tanggal_mulai=${encodeURIComponent(tanggalMulai)}&tanggal_selesai=${encodeURIComponent(tanggalSelesai)}`;
    }
