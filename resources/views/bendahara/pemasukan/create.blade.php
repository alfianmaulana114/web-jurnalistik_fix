...
<div class="container mx-auto px-4 py-6 max-w-4xl">
    <div class="bg-white rounded-lg shadow-sm p-6">
        <h3 class="text-2xl font-medium text-gray-800 mb-6">Tambah Pemasukan Baru</h3>
        <form action="{{ route('bendahara.pemasukan.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <!-- Tanggal -->
                        <div class="mb-4">
                            <label for="tanggal_pemasukan" class="block text-sm font-medium text-gray-700 mb-2">Tanggal <span class="text-red-500">*</span></label>
                            <input type="date" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:border-transparent @error('tanggal_pemasukan') border-red-500 @enderror" 
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:border-transparent @error('deskripsi') border-red-500 @enderror" 
                        ...
                        <div class="mb-4">
                            ...
                            <select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:border-transparent @error('kategori') border-red-500 @enderror" 
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:border-transparent @error('jumlah') border-red-500 @enderror" 
                        ...
                        <!-- Sumber -->
                        <div class="mb-4">
                            <label for="sumber_pemasukan" class="block text-sm font-medium text-gray-700 mb-2">Sumber <span class="text-red-500">*</span></label>
                            <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:border-transparent @error('sumber_pemasukan') border-red-500 @enderror" 
                    ...
                    <div>
                        ...
                        <div class="mb-4" id="kas_anggota_group" style="display: none;">
                            <label for="kas_anggota_id" class="block text-sm font-medium text-gray-700 mb-2">Kas Anggota Terkait</label>
                            <select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:border-transparent @error('kas_anggota_id') border-red-500 @enderror" 
                        ...
                        <div class="mb-4">
                            ...
                            <select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:border-transparent @error('metode_pembayaran') border-red-500 @enderror" 
                        ...
                        <!-- Bukti Transfer (URL) -->
                        <div class="mb-4">
                            <label for="bukti_pemasukan" class="block text-sm font-medium text-gray-700 mb-2">Link Bukti Transfer</label>
                            <input type="url" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-400 focus:border-transparent @error('bukti_pemasukan') border-red-500 @enderror" 
                                   id="bukti_pemasukan" name="bukti_pemasukan" value="{{ old('bukti_pemasukan') }}" placeholder="https://contoh.com/bukti-transfer">
                            <p class="text-gray-500 text-xs mt-1">
                                Tempelkan tautan ke bukti (gambar atau dokumen) yang dapat diakses.
                            </p>
                        ...
                        <div class="bg-blue-50 rounded-lg p-3">
                            ...
                            <ul class="text-xs text-blue-700 space-y-1">
                                ...
                                <li>• Status ditetapkan sistem dan memerlukan verifikasi bendahara</li>
                                <li>• Jika kategori "Kas Anggota", pilih anggota terkait</li>
                                <li>• Masukkan link bukti transfer untuk transparansi</li>
                            </ul>
                        </div>
                    </div>
                </div>
