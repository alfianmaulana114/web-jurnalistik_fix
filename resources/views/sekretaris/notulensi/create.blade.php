            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2">
                    ...
                    <div class="flex items-center gap-3">
                        <button type="button" onclick="showPesertaModal()" class="px-3 py-2 bg-blue-600 text-white rounded-md text-sm hover:bg-blue-700">
                            Pilih Peserta
                        </button>
                        <span id="pesertaCount" class="text-sm text-gray-600">Tidak ada peserta terpilih</span>
                    </div>
                    <div id="pesertaSelectedList" class="mt-2 bg-gray-50 rounded-md p-3 text-sm text-gray-700 hidden"></div>
...
document.addEventListener('DOMContentLoaded', () => {
    // Attach onchange handlers to status selects to keep summary synced
    ...
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full relative z-10">
            ...
            <div class="px-6 py-4 space-y-4">
                <div>
                    <input type="text" id="pesertaSearch" oninput="filterPeserta()" placeholder="Cari nama anggota..." class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-400 focus:border-blue-400">
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="peserta-item" data-name="{{ $user->name }}" data-user-id="{{ $user->id }}">
                                ...
                                <td class="px-3 py-2">
                                    <select data-user-id="{{ $user->id }}" class="status-select mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-400 focus:border-blue-400" onchange="updatePesertaSummary()" disabled>
