            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="date" name="tanggal" id="tanggal" value="{{ old('tanggal', $notulensi->tanggal->format('Y-m-d')) }}" required
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('tanggal')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="time" name="waktu_mulai" id="waktu_mulai" value="{{ old('waktu_mulai', \Carbon\Carbon::parse($notulensi->waktu_mulai)->format('H:i')) }}" required
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('waktu_mulai')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="time" name="waktu_selesai" id="waktu_selesai" value="{{ old('waktu_selesai', $notulensi->waktu_selesai ? \Carbon\Carbon::parse($notulensi->waktu_selesai)->format('H:i') : '') }}"
                            class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        @error('waktu_selesai')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div>
                    ...
                    <textarea name="peserta" id="peserta" rows="3"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Daftar peserta rapat...">{{ old('peserta', $notulensi->peserta) }}</textarea>
                    @error('peserta')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="tindak_lanjut" id="tindak_lanjut" rows="4"
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Tindak lanjut yang perlu dilakukan...">{{ old('tindak_lanjut', $notulensi->tindak_lanjut) }}</textarea>
                    @error('tindak_lanjut')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
