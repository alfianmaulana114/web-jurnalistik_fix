        ...
        <div class="px-6 py-4 border-b border-[#D8C4B6]/40">
            <div class="flex items-center justify-between">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-4 mt-1">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                @if(str_contains($user->role, 'koordinator')) bg-purple-100 text-purple-800
                                @elseif(str_contains($user->role, 'anggota')) bg-blue-100 text-blue-800
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route(($routePrefix ?? 'sekretaris.view').'.users.index') }}" class="inline-flex items-center px-3 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                ...
                <div class="px-6 py-4">
                    <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900"><a href="mailto:{{ $user->email }}" class="text-[#1b334e] hover:text-[#f9b61a]">{{ $user->email }}</a></dd>
                        </div>
                        <div>
