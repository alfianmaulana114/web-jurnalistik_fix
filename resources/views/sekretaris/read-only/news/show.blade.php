        ...
        <div class="p-6 border-b border-[#D8C4B6]/40">
            <div class="flex justify-between items-start">
                ...
                <div class="flex space-x-2">
                    <a href="{{ route(($routePrefix ?? 'sekretaris.view').'.news.index') }}" 
...
<style>
    ...
    .prose h1, .prose h2, .prose h3, .prose h4, .prose h5, .prose h6 {
        color: #374151; font-weight: 600; margin-top: 1.5rem; margin-bottom: 0.5rem;
    }
    .prose p { margin-bottom: 1rem; line-height: 1.7; }
    .prose ul, .prose ol { margin: 1rem 0; padding-left: 1.5rem; }
    .prose blockquote {
        border-left: 4px solid #e5e7eb; padding-left: 1rem; margin: 1rem 0; font-style: italic; color: #6b7280;
    }
</style>
@endpush
@endsection
