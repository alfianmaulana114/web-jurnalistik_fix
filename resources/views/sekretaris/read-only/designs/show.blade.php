...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-2">
            <a href="{{ route(($routePrefix ?? 'sekretaris.view').'.designs.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-blue-600">
                            @if($design->berita)
                                <a href="{{ route(($routePrefix ?? 'sekretaris.view').'.news.show', $design->berita->id) }}" class="hover:underline">{{ $design->berita->title ?? $design->berita->judul }}</a>
                            @else
