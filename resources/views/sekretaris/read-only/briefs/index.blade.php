...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg border border-[#D8C4B6]/40 shadow-sm hover:shadow-md transition-all p-6">
        <form method="GET" action="{{ route(($routePrefix ?? 'sekretaris.view').'.briefs.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
            ...
            <div class="flex items-end space-x-2">
                ...
                <a href="{{ route(($routePrefix ?? 'sekretaris.view').'.briefs.index') }}" class="inline-flex items-center px-4 py-2 border border-[#D8C4B6]/40 rounded-lg shadow-sm text-sm font-medium text-[#1b334e] bg-white hover:bg-[#f9b61a]/10 transition-all">
                ...
                <tbody class="bg-white divide-y divide-[#D8C4B6]/40" id="briefsTableBody">
                    ...
                    <tr class="hover:bg-[#f9b61a]/5 transition-colors">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-[#1b334e]">
                                        <a href="{{ route(($routePrefix ?? 'sekretaris.view').'.briefs.show', $brief) }}" class="hover:text-[#f9b61a]">
                                            {{ $brief->judul }}
                                        </a>
                                    </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="{{ route(($routePrefix ?? 'sekretaris.view').'.briefs.show', $brief) }}" class="text-[#1b334e] hover:bg-[#f9b61a]/10 p-2 rounded-lg transition-all" title="Lihat Detail">
