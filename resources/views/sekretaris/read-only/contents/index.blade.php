    ...
    <div class="bg-white rounded-lg border border-[#D8C4B6]/40 shadow-sm hover:shadow-md transition-all">
        ...
        <div class="p-6">
            <div class="mb-6 p-4 bg-[#f9b61a]/5 rounded-lg border border-[#D8C4B6]/40">
                <form method="GET" action="{{ route(($routePrefix ?? 'sekretaris.view').'.contents.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                    ...
                    <div class="flex items-end space-x-2">
                        ...
                        <a href="{{ route(($routePrefix ?? 'sekretaris.view').'.contents.index') }}" class="bg-white text-[#1b334e] border border-[#D8C4B6]/40 px-4 py-2 rounded-lg text-sm hover:bg-[#f9b61a]/10 transition-all">
                        ...
                        @forelse($contents as $content)
                            <tr class="hover:bg-[#f9b61a]/5 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route(($routePrefix ?? 'sekretaris.view').'.contents.show', $content) }}" class="text-[#1b334e] hover:bg-[#f9b61a]/10 p-2 rounded-lg transition-all" title="Lihat Detail">
