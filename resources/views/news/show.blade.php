        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-8">
                ...
                <div class="bg-white rounded-lg shadow-sm mt-8 p-6">
                    ...
                    <!-- Comment Form -->
                    <form action="{{ route('news.comments.store', $news->slug) }}" method="POST" class="mb-8">
                        @csrf
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" required
                                           ...
                                           maxlength="255"
                                           pattern="[a-zA-Z0-9\s\.\-]+"
                                           title="Nama hanya boleh mengandung huruf, angka, spasi, titik, dan tanda hubung">
                                    @error('name')
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="border-l-4 border-blue-200 pl-4 py-2" id="comment-{{ $comment->id }}">
                            <div class="flex items-start justify-between mb-2">
                                <div>
                                    <h4 class="font-semibold text-gray-900">{{ htmlspecialchars($comment->name, ENT_QUOTES, 'UTF-8') }}</h4>
                                    <p class="text-sm text-gray-500">{{ htmlspecialchars($comment->email, ENT_QUOTES, 'UTF-8') }}</p>
                                </div>
                                <span class="text-xs text-gray-500">{{ $comment->created_at->diffForHumans() }}</span>
                            </div>
                            <p class="text-gray-700 mt-2 whitespace-pre-wrap">{{ htmlspecialchars($comment->content, ENT_QUOTES, 'UTF-8') }}</p>
                        </div>
                        @empty
