...
<div class="container mx-auto px-4 py-6 max-w-4xl">
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <form action="{{ route('koordinator-redaksi.news.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-8">
                ...
                <div class="flex flex-col items-center p-6 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors">
                    ...
                    <button type="button" onclick="document.getElementById('image').click()" class="px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors">
            ...
            <div class="mb-4">
                <div class="inline-flex rounded-md shadow-sm" role="group">
                    <button type="button" class="px-4 py-2 text-sm font-medium border border-gray-300 rounded-l-md bg-purple-600 text-white" data-lang-toggle="id">Indonesia</button>
            ...
            <div class="mt-8 flex justify-end">
                <button type="submit" id="submitBtn" class="px-6 py-3 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors">
...
<div id="cropModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-[10000] backdrop-blur-sm">
    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-2xl p-6 w-[90%] max-w-3xl">
        ...
        <div class="mt-6 flex justify-end space-x-3">
            ...
            <button type="button" id="cropBtn" class="px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Elements found:', {
        ...
        fileInput: !!fileInput,
        preview: !!preview,
        tempImageIdInput: !!tempImageIdInput,
        cropBtn: !!cropBtn,
        csrfToken: !!csrfToken,
    ...
    fileInput.addEventListener('change', function(e) {
        ...
        if (this.files && this.files[0]) {
            ...
            reader.onload = function(e) {
                console.log('File loaded, setting crop image src');
                cropImage.src = e.target.result;
                console.log('Showing modal - before:', modal.classList.contains('hidden'));
                modal.classList.remove('hidden');
                modal.style.display = 'flex';
                console.log('Showing modal - after:', modal.classList.contains('hidden'));
    ...
    cropBtn.addEventListener('click', function() {
        ...
        canvas.toBlob(function(blob) {
            ...
            fetch('/koordinator-redaksi/temp-images', {
                method: 'POST',
                body: formData,
                headers: {
