    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="p-6 border-b border-gray-200">
            <div class="flex justify-between items-start">
                ...
                <div class="flex space-x-2">
                    <a href="{{ route('koordinator-redaksi.news.edit', $news->id) }}" 
                       class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">
                        <i class="fas fa-edit mr-2"></i>Edit
                    </a>
                    <a href="{{ route('koordinator-redaksi.news.index') }}" 
        ...
        <div class="p-6">
            ...
            <div class="prose max-w-none">
                <h3 class="text-xl font-semibold text-gray-800 mb-4">Konten Berita</h3>
        ...
        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-2">
                    <form action="{{ route('koordinator-redaksi.news.destroy', $news->id) }}" 
                          method="POST" 
                          class="inline-block"
