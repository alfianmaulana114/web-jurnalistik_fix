...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600">Lihat notulensi rapat UKM Jurnalistik</p>
        </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <a href="{{ route('koordinator-redaksi.view.sekretaris.notulensi.show', $n) }}" class="px-3 py-1 text-xs rounded-md bg-blue-600 text-white hover:bg-blue-700">Lihat</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
