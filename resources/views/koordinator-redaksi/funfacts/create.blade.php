...
<div class="container mx-auto px-4 py-6 max-w-4xl">
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <form action="{{ route('koordinator-redaksi.funfacts.store') }}" method="POST">
            @csrf
            ...
            <div class="mt-8 flex justify-end space-x-4">
                <a href="{{ route('koordinator-redaksi.funfacts.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition-colors">Batal</a>
