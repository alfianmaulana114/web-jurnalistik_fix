...
<div class="container mx-auto px-4 py-6 max-w-4xl">
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <form action="{{ route('koordinator-redaksi.funfacts.update', $funfact) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="flex justify-end space-x-4 mt-6">
                <a href="{{ route('koordinator-redaksi.funfacts.show', $funfact) }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition-colors">Batal</a>
