{{-- Dashboard Anggota Litbang
    - Fokus aktivitas anggota: brief yang ditugaskan dan progres
    - Akses cepat ke daftar dan detail brief
--}}
@extends('layouts.anggota-litbang')

@section('title', 'Dashboard')
@section('header', 'Dashboard Anggota Litbang')
    ...
    <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg shadow-lg p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-green-100 mt-1">Aktivitas Divisi Litbang berfokus pada Brief</p>
            </div>
