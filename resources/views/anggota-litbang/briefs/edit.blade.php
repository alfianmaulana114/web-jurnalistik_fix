...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST" action="{{ route('anggota-litbang.briefs.update', $brief) }}" class="space-y-4">
            @csrf
            @method('PUT')
            <div>
            ...
            <div class="flex justify-end space-x-2">
                <a href="{{ route('anggota-litbang.briefs.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50">Batal</a>
