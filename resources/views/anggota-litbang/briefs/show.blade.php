    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-start justify-between">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('anggota-litbang.briefs.edit', $brief) }}" class="px-4 py-2 bg-yellow-500 text-white rounded-md hover:bg-yellow-600"><i class="fas fa-edit mr-2"></i>Edit</a>
                <a href="{{ route('anggota-litbang.briefs.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300"><i class="fas fa-arrow-left mr-2"></i>Kembali</a>
            </div>
        </div>
