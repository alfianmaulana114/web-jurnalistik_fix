@extends('layouts.anggota-litbang')
...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('anggota-litbang.briefs.create') }}" class="inline-flex items-center px-4 py-2 bg-green-600 rounded-md font-semibold text-xs text-white hover:bg-green-700">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <div class="text-sm font-medium text-gray-900">
                                <a href="{{ route('anggota-litbang.briefs.show', $brief) }}" class="hover:text-green-600">{{ $brief->judul }}</a>
                            </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-2">
                                <a href="{{ route('anggota-litbang.briefs.show', $brief) }}" class="text-gray-600 hover:text-gray-900" title="Lihat">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('anggota-litbang.briefs.edit', $brief) }}" class="text-yellow-600 hover:text-yellow-900" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('anggota-litbang.briefs.destroy', $brief) }}" method="POST" class="inline" onsubmit="return confirm('Hapus brief ini?')">
                                    @csrf
                                    @method('DELETE')
