                    ...
                    <tr class="hover:bg-gray-50">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900">
                                        <a href="{{ route('koordinator-jurnalistik.funfacts.show', $funfact) }}" class="hover:text-red-600">
                                            {{ $funfact->judul }}
                                        </a>
                                    </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-2">
                                <a href="{{ route('koordinator-jurnalistik.funfacts.show', $funfact) }}" class="text-gray-600 hover:text-gray-900" title="Lihat Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('koordinator-jurnalistik.funfacts.edit', $funfact) }}" class="text-yellow-600 hover:text-yellow-900" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('koordinator-jurnalistik.funfacts.destroy', $funfact) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus funfact ini?')">
                                    @csrf
                                    @method('DELETE')
