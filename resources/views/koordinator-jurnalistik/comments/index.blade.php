            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-500">{{ Str::limit($comment->news->title ?? 'Berita tidak ditemukan', 30) }}</div>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            ...
                            @endif
                            <form action="{{ route('koordinator-jurnalistik.comments.destroy', $comment->id) }}" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')
