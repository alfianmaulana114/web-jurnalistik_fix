    ...
    <div class="bg-white rounded-lg shadow-sm p-6 space-y-4">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <a href="{{ route('koordinator-jurnalistik.brief-humas.edit', $briefHumas) }}" class="px-4 py-2 bg-yellow-500 text-white rounded">Edit</a>
                <a href="{{ route('koordinator-jurnalistik.brief-humas.index') }}" class="px-4 py-2 bg-gray-200 rounded">Kembali</a>
            </div>
        </div>
        <div>
