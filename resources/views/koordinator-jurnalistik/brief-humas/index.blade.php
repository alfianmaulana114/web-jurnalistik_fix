...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('koordinator-jurnalistik.brief-humas.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
    ...
    <div class="bg-white rounded-lg shadow-sm p-4">
        <form method="GET" class="flex gap-3 items-end">
            ...
            <a href="{{ route('koordinator-jurnalistik.brief-humas.index') }}" class="px-4 py-2 border rounded-md text-sm">Reset</a>
        </form>
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm text-right">
                        <a href="{{ route('koordinator-jurnalistik.brief-humas.show', $brief) }}" class="px-3 py-1 bg-gray-200 rounded hover:bg-gray-300">Lihat</a>
                        <a href="{{ route('koordinator-jurnalistik.brief-humas.edit', $brief) }}" class="px-3 py-1 bg-yellow-500 text-white rounded hover:bg-yellow-600">Edit</a>
                        <form action="{{ route('koordinator-jurnalistik.brief-humas.destroy', $brief) }}" method="POST" class="inline" onsubmit="return confirm('Hapus brief ini?')">
                            @csrf
                            @method('DELETE')
