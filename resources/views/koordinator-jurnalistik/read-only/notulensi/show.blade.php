...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route('koordinator-jurnalistik.sekretaris.notulensi.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mt-6">
            ...
            <a href="{{ route('koordinator-jurnalistik.sekretaris.notulensi.download', $notulensi) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">
