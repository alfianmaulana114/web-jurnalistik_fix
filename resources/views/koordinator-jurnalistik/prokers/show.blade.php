...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route('koordinator-jurnalistik.prokers.edit', $proker) }}" class="inline-flex items-center px-4 py-2 bg-[#1b334e] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-[#16283e] focus:outline-none transition ease-in-out duration-150">
                <i class="fas fa-edit mr-2"></i>
                Edit
            </a>
            <a href="{{ route('koordinator-jurnalistik.prokers.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:outline-none transition ease-in-out duration-150">
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    ...
                    <div class="text-center py-8">
                        ...
                        <a href="{{ route('koordinator-jurnalistik.designs.create', ['proker_id' => $proker->id]) }}" class="inline-flex items-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-700 focus:bg-red-700 active:bg-red-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150">
        ...
        <div class="space-y-6">
                ...
                <div class="p-6">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div class="bg-red-600 h-2 rounded-full" style="width: {{ $proker->getProgress() }}%"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6 space-y-3">
                    <a href="{{ route('koordinator-jurnalistik.prokers.edit', $proker) }}" class="w-full inline-flex items-center justify-center px-4 py-2 bg-yellow-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-yellow-700 focus:bg-yellow-700 active:bg-yellow-900 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 transition ease-in-out duration-150">
                        <i class="fas fa-edit mr-2"></i>
                        Edit Program Kerja
                    </a>
                    <form action="{{ route('koordinator-jurnalistik.prokers.destroy', $proker) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus program kerja ini?')">
                        @csrf
                        @method('DELETE')
