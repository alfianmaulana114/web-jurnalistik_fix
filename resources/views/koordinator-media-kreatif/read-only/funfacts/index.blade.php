...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg border border-[#D8C4B6]/40 shadow-sm hover:shadow-md transition-all p-6">
        <form method="GET" action="{{ route(($routePrefix ?? 'koordinator-media-kreatif.view').'.funfacts.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
            ...
            <div class="flex items-end space-x-2">
                ...
                <a href="{{ route(($routePrefix ?? 'koordinator-media-kreatif.view').'.funfacts.index') }}" class="px-4 py-2 bg-white text-[#1b334e] border border-[#D8C4B6]/40 rounded-lg font-semibold text-xs uppercase tracking-widest hover:bg-[#f9b61a]/10 focus:outline-none transition-all duration-150">
        ...
        <div class="funfact-card group rounded-lg border border-[#D8C4B6]/40 bg-white p-6 shadow-sm transition-all hover:shadow-md">
            ...
            <div class="flex items-center justify-between border-t border-[#D8C4B6]/40 pt-4">
                ...
                <div class="flex items-center gap-1">
                    <a href="{{ route(($routePrefix ?? 'koordinator-media-kreatif.view').'.funfacts.show', $funfact) }}" class="rounded-lg p-1.5 text-[#1b334e] hover:bg-[#f9b61a]/10 transition-all" title="Lihat">
