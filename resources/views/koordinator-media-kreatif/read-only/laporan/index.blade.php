...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Lihat berbagai laporan keuangan organisasi (Read-Only)</p>
        </div>
...
function applyFilter() {
    ...
    window.location.href = '/koordinator-media-kreatif/view/laporan' + '?' + params.toString();
}

function resetFilter() {
    document.getElementById('filterForm').reset();
    window.location.href = '/koordinator-media-kreatif/view/laporan';
}
...
function viewReport(type) {
    ...
    let url = `/koordinator-media-kreatif/view/laporan?tahun=${tahun}&periode=${periode}`;
...
function exportReport(type) {
    ...
    let url = `/koordinator-media-kreatif/view/laporan/export-excel?type=${type}&tahun=${tahun}&periode=${periode}`;
    if (periode === 'custom' && tanggalMulai && tanggalSelesai) {
        url += `&tanggal_mulai=${encodeURIComponent(tanggalMulai)}&tanggal_selesai=${encodeURIComponent(tanggalSelesai)}`;
    }
...
function exportAllReports() {
    ...
    let url = `/koordinator-media-kreatif/view/laporan/export-excel?type=total-saldo&tahun=${tahun}&periode=${periode}`;
    if (periode === 'custom' && tanggalMulai && tanggalSelesai) {
        url += `&tanggal_mulai=${encodeURIComponent(tanggalMulai)}&tanggal_selesai=${encodeURIComponent(tanggalSelesai)}`;
    }
