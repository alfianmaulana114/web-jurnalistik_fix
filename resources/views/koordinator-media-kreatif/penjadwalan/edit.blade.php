...
<div class="container mx-auto px-4 py-6 max-w-2xl">
    <div class="rounded-xl border border-[#D8C4B6]/40 bg-white shadow-sm p-6">
        ...
        <form action="{{ route('koordinator-media-kreatif.penjadwalan.update', $penjadwalan->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mt-8 flex justify-end space-x-4">
                <a href="{{ route('koordinator-media-kreatif.penjadwalan.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors">Batal</a>
