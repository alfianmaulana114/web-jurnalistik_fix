...
use App\Services\KoordinatorRedaksi\FunfactService;
...
class FunfactController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('koordinator-redaksi.funfacts.index', $data);
    }
    ...
    public function create(): View
    {
        ...
        return view('koordinator-redaksi.funfacts.create', $data);
    }
    ...
    public function show(Funfact $funfact): View
    {
        ...
        return view('koordinator-redaksi.funfacts.show', $data);
    }
    ...
    public function edit(Funfact $funfact): View
    {
        ...
        return view('koordinator-redaksi.funfacts.edit', $data);
    }
