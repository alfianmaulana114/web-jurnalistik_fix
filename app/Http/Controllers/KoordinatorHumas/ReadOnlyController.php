...
/**
 * Controller untuk Koordinator Humas - Read Only Access
 * 
 * Controller ini memberikan akses read-only untuk koordinator humas ke semua fitur
 * yang sama seperti koordinator litbang (read-only). Koordinator humas hanya bisa melihat data
...
class ReadOnlyController extends Controller
{
    ...
    public function dashboard(): View
    {
        ...
        return view('koordinator-humas.read-only.dashboard', $data);
    }
    ...
    public function newsIndex(Request $request): View
    {
        ...
        return view('koordinator-humas.read-only.news.index', $data);
    }
    ...
    public function newsShow($id): View
    {
        ...
        return view('koordinator-humas.read-only.news.show', compact('news'));
    }
    ...
    public function prokersIndex(Request $request): View
    {
        ...
        return view('koordinator-humas.read-only.prokers.index', $data);
    }
    ...
    public function prokersShow(Proker $proker): View
    {
        ...
        return view('koordinator-humas.read-only.prokers.show', compact('proker'));
    }
    ...
    public function briefsIndex(Request $request): View
    {
        ...
        return view('koordinator-humas.read-only.briefs.index', $data);
    }
    ...
    {
        $brief->load(['contents']);
        return view('koordinator-humas.read-only.briefs.show', compact('brief'));
    }
    ...
    public function designsIndex(Request $request): View
    {
        ...
        return view('koordinator-humas.read-only.designs.index', $data);
    }
    ...
    {
        return view('koordinator-humas.read-only.designs.show', compact('design'));
    }
    ...
    public function funfactsIndex(Request $request): View
    {
        ...
        return view('koordinator-humas.read-only.funfacts.index', $data);
    }
    ...
    {
        return view('koordinator-humas.read-only.funfacts.show', compact('funfact'));
    }
    ...
    public function usersIndex(Request $request): View
    {
        ...
        return view('koordinator-humas.read-only.users.index', compact('users'));
    }
    ...
    {
        return view('koordinator-humas.read-only.users.show', compact('user'));
    }
    ...
    public function sekretarisNotulensiIndex(): View
    {
        ...
        return view('koordinator-humas.read-only.sekretaris.notulensi.index', $data);
    }
    ...
    public function sekretarisNotulensiShow(Notulensi $notulensi): View
    {
        ...
        return view('koordinator-humas.read-only.sekretaris.notulensi.show', $data);
    }
    ...
    public function sekretarisAbsenIndex(Request $request): View
    {
        ...
        return view('koordinator-humas.read-only.sekretaris.absen.index', $data);
    }
    ...
    public function laporanKeuangan(Request $request): View
    {
        try {
            ...
            return view('koordinator-humas.read-only.laporan.index', $data);
        } catch (\Exception $e) {
