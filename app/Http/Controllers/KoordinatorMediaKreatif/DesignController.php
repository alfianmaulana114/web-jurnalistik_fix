...
class DesignController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('koordinator-media-kreatif.designs.index', $data);
    }
    ...
    {
        $data = $this->designService->create($request);
        return view('koordinator-media-kreatif.designs.create', $data);
    }
    ...
    public function show(Design $design): View
    {
        ...
        return view('koordinator-media-kreatif.designs.show', $data);
    }
    ...
    public function edit(Design $design): View
    {
        ...
        return view('koordinator-media-kreatif.designs.edit', $data);
    }
