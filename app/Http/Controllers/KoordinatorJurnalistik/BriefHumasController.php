...
use App\Services\KoordinatorJurnalistik\BriefHumasService;
...
class BriefHumasController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('koordinator-jurnalistik.brief-humas.index', $data);
    }

    public function create(): View
    {
        $data = $this->service->create();
        return view('koordinator-jurnalistik.brief-humas.create', $data);
    }
    ...
    public function show(BriefHumas $briefHumas): View
    {
        ...
        return view('koordinator-jurnalistik.brief-humas.show', $data);
    }

    public function edit(BriefHumas $briefHumas): View
    {
        $data = $this->service->edit($briefHumas);
        return view('koordinator-jurnalistik.brief-humas.edit', $data);
    }
