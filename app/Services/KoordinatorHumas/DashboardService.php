 ...
 * 
 * Service ini menangani semua logika bisnis terkait dashboard koordinator humas,
 * termasuk pengambilan data statistik divisi humas, brief dari litbang, caption, dan design.
...
class DashboardService
{
     ...
     * - Statistik divisi humas (koordinator dan anggota)
     * - Brief dari litbang
     * - Caption (content)
     * - Design media
     * - Berita terkait divisi humas
     * 
     * @return array Array berisi semua data untuk dashboard
     */
    public function getDashboardData(): array
    {
        // Statistik divisi humas
        $humasStats = $this->getHumasStats();
    ...
    /**
     * Mengambil statistik divisi humas
     * 
     * @return array Statistik koordinator dan anggota humas
     */
    private function getHumasStats(): array
    {
        return [
            'humas_coordinators' => User::where('role', User::ROLE_KOORDINATOR_HUMAS)->count(),
            'humas_members' => User::where('role', User::ROLE_ANGGOTA_HUMAS)->count(),
            'humas_total' => User::whereIn('role', [
