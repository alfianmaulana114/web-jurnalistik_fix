...
/**
 * Service untuk Dashboard Koordinator Litbang
 * 
 * Service ini menangani semua logika bisnis terkait dashboard koordinator litbang,
 * termasuk pengambilan data statistik divisi litbang, brief, caption, dan design.
...
class DashboardService
{
     ...
     * - Statistik divisi litbang (koordinator dan anggota)
     * - Brief dari litbang
     * - Caption (content)
     * - Design media
     * - Berita terkait divisi litbang
     * 
     * @return array Array berisi semua data untuk dashboard
     */
    public function getDashboardData(): array
    {
        // Statistik divisi litbang
    ...
    /**
     * Mengambil statistik divisi litbang
     * 
     * @return array Statistik koordinator dan anggota litbang
     */
    private function getLitbangStats(): array
    {
        return [
            ...
            'litbang_total' => User::whereIn('role', [
    ...
    private function getNewsStats(): array
    {
        ...
        // News sudah terbit = news yang sudah approved DAN punya caption (tampil di home)
        $newsSudahTerbit = $this->safeQuery(function () {
            return News::has('approval')
                ->whereHas('caption')
                ->count();
        }, 0);
        
        // News belum terbit = news yang belum approved ATAU belum punya caption
        $newsBelumTerbit = $this->safeQuery(function () {
