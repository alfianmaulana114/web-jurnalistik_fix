...
/**
 * Service untuk Manajemen Penjadwalan Koordinator Redaksi
 * 
 * Service ini menangani semua logika bisnis terkait penjadwalan anggota redaksi
 * untuk membuat berita. Mengikuti prinsip Single Responsibility dengan fokus
 * pada operasi CRUD penjadwalan.
 */
class PenjadwalanService
{
     ...
     * @return array Data penjadwalan dan anggota redaksi
     */
    public function index(Request $request): array
    {
        ...
        // Ambil semua anggota redaksi
        $anggotaRedaksi = User::whereIn('role', [
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('koordinator-redaksi.penjadwalan.index')
    ...
    private function validatePenjadwalan(Request $request, ?int $id = null): array
    {
        ...
        // Validasi tambahan untuk memastikan user adalah anggota redaksi
        $user = User::find($validated['user_id']);
        if (!$user || !in_array($user->role, [User::ROLE_ANGGOTA_REDAKSI, User::ROLE_KOORDINATOR_REDAKSI])) {
            throw \Illuminate\Validation\ValidationException::withMessages([
                'user_id' => ['User yang dipilih harus anggota atau koordinator redaksi.'],
            ]);
        }
